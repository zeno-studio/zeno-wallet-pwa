//https://github.com/Koniverse/ZenoWallet-Mobile/blob/master/src/constants/termAndCondition/en.ts

export const terms_zh = `
# **使用条款**

本使用条款（“协议”）规定您使用ZenoWallet扩展程序应用、移动应用程序和网站仪表盘应用程序（统称为“ZenoWallet应用程序”）及其任何相关产品和服务（统称为“服务”）的一般条款和条件。

本协议对您（“用户”、“您”或“您的”）和本应用程序开发商（“运营商”、“我们”或“我们的”）具有法律约束力。如果您代表企业或其他法律实体签署本协议，即表示您有权将该实体约束于本协议，在这种情况下，“用户”、“您”或“您的”等术语应指该实体。

如果您没有此类权限，或者您不同意本协议的条款，则您不得接受本协议，也不得访问和使ZenoWallet应用程序和服务。如您访问和使用ZenoWallet应用程序和服务，即视为您承认您已阅读、理解并同意接受本协议条款的约束。您承认本协议是您与运营商之间的合同，即使它是电子的且未由您亲自签署，并且它管辖您对ZenoWallet应用程序和服务的使用。

本协议以各种语言书就，若有异议，以英文为准。

#### **账户及会员**

如果您在ZenoWallet应用程序中创建钱包账户，您有责任维护钱包的安全，并对钱包发生的所有活动以及与之相关的任何其他行动负全部责任。您应明白，我们无法访问与钱包相关的任何信息，也无法将其发送给任何其他方。

所有此类信息都存储在您的设备上，我们无法访问这些设备，因此您对其安全承担全部责任。您的钱包私钥、助记词不会与其他数据一起备份，因此如果您卸载ZenoWallet应用程序，您将无法从备份中恢复私钥、助记词。

#### **隐私政策**

我们尊重您的隐私，并致力于通过遵守本隐私政策（“政策”）来保护您的隐私。本政策描述我们可能从您那里收集或您可能在ZenoWallet应用程序、ZenoWallet网站及其任何相关产品和服务上所提供的信息类别，以及我们如何收集、使用、维护、保护和披露该信息的。访问和使用我们的服务即视为您已阅读、理解并同意受本政策条款的约束。本政策不会用于不由我们拥有或管辖的企业以及不受我们雇用或管理的个人。
...
尽管ZenoWallet应用程序和服务可能连接到其他资源（如网站、其他应用程序等），但除非特别说明，否则我们不会直接或间接表明对任何链接资源的任何批准、关联、赞助、背书或附属关系。我们不负责审查或评估，也不保证任何企业或个人的产品或其资源的内容。

我们不对任何其他第三方的行为、产品、服务及内容承担任何责任。您应仔细审查您通过ZenoWallet应用程序中的链接进行访问的任何资源的法律声明和其他使用条件。您连接到任何其他场外资源的风险由您自己承担。

#### **禁止用途**

除本协议中规定的其他条款外，您被禁止使用ZenoWallet应用程序和服务于下列用途：
...
6. 提交虚假或误导性信息
7. 上传或传输病毒或任何其他类型的恶意代码，这些代码即将或可能以任何方式使用，从而影响到ZenoWallet应用程序和服务、第三方产品和服务或互联网的功能或操作
8. 发送垃圾邮件、网络钓鱼、作弊、跟踪、数据收集或网页数据抓取
9. 出于任何淫秽或不道德的目的
10. 干扰或规避ZenoWallet应用程序和服务、第三方产品和服务或互联网的安全功能
...
本协议不转让给您运营商或第三方拥有的任何知识产权，且该知识产权的所有权利、所有权和权益将仅由运营商（等其他相关方）保留。与ZenoWallet应用程序和服务相关的所有商标、服务标记、图形和徽标均为运营商或其许可人的商标或注册商标。

与ZenoWallet应用程序和服务相关的其他商标、服务标记、图形和徽标可能是其他第三方的商标。使用ZenoWallet应用程序和服务不向您授予复制或以其他方式使用任何运营商或第三方商标的权利或许可。
...
您同意赔偿并让运营商及其附属公司、董事、高级职员、员工、代理人、供应商和许可人免受由任何第三方指控、索赔、行动、纠纷引起的任何责任、损失、损害或成本，包括合理的律师费，或因您使用ZenoWallet应用程序和服务或您的任何故意不当行为而对他们提出的要求。
...
我们保留随时自行决定修改本协议或其与ZenoWallet应用程序和服务相关的条款的权利。当协议有修改时，我们将更新此页面底部的修改日期。我们也可以自行决定以其他方式向您发出通知，例如通过您所提供的联系信息发出通知。

除非另有规定，本协议的更新版本将在发布修订后的协议之后立即生效。您在修订后的协议生效日期（或当时指定的其他行为）后继续使用ZenoWallet应用程序和服务将构成您对这些更改的同意。

#### **接受这些条款**

您承认您已阅读本协议并同意其所有条款和条件。通过访问和使用ZenoWallet应用程序和服务，您同意接受本协议的约束。若您不同意遵守本协议的条款，您则无权访问或使用ZenoWallet应用程序和服务。
